  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
        ...
        <h1 className="text-gray-900 text-3xl title-font font-medium mb-4">Order Id: #8965</h1>
        <p className="leading-relaxed mb-4">Your order has been successfully place!</p>
        
        <div className="flex mb-4">
          <a className="flex-grow border-b-2 text-center  py-2 text-lg px-1">Item Description</a>
        ...
        <div className="flex">
          <span className="title-font font-medium text-xl text-gray-900">SubTotal: ₹{3*499}</span>
