...
export default function Home() {
  return (
    <>
      ...
      <img src="/logo.png" alt="codeswear" className="w-full" />
      {/* <div classNameName="absolute bottom-0 left-1/2 transform -translate-x-1/2 pb-8 text-center w-full">
        <h1 classNameName="text-3xl font-bold text-blue-800"> </h1>
      </div> */}
      </div>
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      ...
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Wear whatever you want to, with codeswear.com !</p>
    </div>
